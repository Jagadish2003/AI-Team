...
CLIENT_ID        = os.environ.get("STRS_CLIENT_ID")
USERNAME         = os.environ.get("STRS_USER")
PRIVATE_KEY_PATH = "token_generation/strs/server_strs.key"
TOKEN_FILE       = "token_generation/strs/strs_token.json"
