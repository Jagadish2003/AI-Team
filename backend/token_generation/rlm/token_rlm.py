...
CLIENT_ID = os.environ.get("RLM_CLIENT_ID")
USERNAME = os.environ.get("RLM_USER")
PRIVATE_KEY_PATH = "token_generation/rlm/server_rlm.key"
TOKEN_FILE = "token_generation/rlm/rlm_token.json"
