 ...
 *
 * PostgreSQL case note:
 *   PostgreSQL lowercases unquoted identifiers. Schema and table names are
 *   typically lowercase and displayed verbatim from information_schema.
 *   No special case tooltip needed (unlike Oracle).
 *
 * Role enforcement:
