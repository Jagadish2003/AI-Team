 ...
 *
 * Oracle case sensitivity note (AC18):
 *   ALL_COLUMNS returns schema and table names in UPPERCASE (e.g. "HR", "EMPLOYEES").
 *   Names are displayed verbatim — never lowercased. The tooltip communicates this
 *   to the user: 'Oracle schema names are case-sensitive — shown exactly as stored
 *   in the database.'
 *
 * Role enforcement:
...
export default function OracleScopePicker({
  ...
  return (
    <div className="mt-4">
      ...
      {/* AC18 — Oracle case-sensitivity tooltip, exact text from spec */}
      <p className="text-[11px] text-muted/70 mb-3 leading-relaxed italic">
        Oracle schema names are case-sensitive — shown exactly as stored in the database.
      </p>
      ...
      {/* Save button — disabled with tooltip for Viewer role (AC14) */}
      <button
        type="button"
        onClick={handleSave}
