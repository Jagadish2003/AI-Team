 ...
 *   OWNER and TABLE_NAME in uppercase). Schema and table names displayed here
 *   are shown exactly as returned from ALL_COLUMNS. Scope declarations must
 *   use the exact case shown — usually uppercase.
 *
 * Role enforcement:
...
export default function OracleScopePicker({
  ...
  return (
    <div className="mt-4">
      ...
      {/* AC18: Oracle case-sensitivity tooltip */}
      <p
        className="text-xs text-muted mb-1 leading-relaxed"
        title="Oracle schema names are case-sensitive — shown exactly as stored in the database."
      >
        Select schemas and tables AgentIQ may query. Oracle schema names are
        case-sensitive — shown exactly as stored in the database.
      </p>

      <p className="text-xs text-muted mb-3 leading-relaxed">
        Selecting a schema without expanding allows any table in that schema.
      </p>
